...
public class ChannelViewModel : INotifyPropertyChanged
{
    ...
    public float GainLinear { get => _gainLinear; set { _gainLinear = Math.Clamp(value, 0f, 2f); OnPropertyChanged(); OnPropertyChanged(nameof(GainDb)); OnPropertyChanged(nameof(GainPercent)); } }
